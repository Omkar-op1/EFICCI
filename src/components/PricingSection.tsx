        ...
        <div className="row">
          ...
          <div className="col-md-4 col-sm-6">
            <div className="pricing-thumb">
              ...
              <div className="pricing-bottom">
                <span className="pricing-dollar">$200/mo</span>
                <a href="#" className="section-btn pricing-btn">
                  Register now
                </a>
              </div>
            </div>
          ...
          <div className="col-md-4 col-sm-6">
            <div className="pricing-thumb">
              ...
              <div className="pricing-bottom">
                <span className="pricing-dollar">$350/mo</span>
                <a href="#" className="section-btn pricing-btn">
                  Register now
                </a>
              </div>
          ...
          <div className="col-md-4 col-sm-6">
            <div className="pricing-thumb">
              ...
              <div className="pricing-bottom">
                <span className="pricing-dollar">$550/mo</span>
                <a href="#" className="section-btn pricing-btn">
                  Register now
                </a>
              </div>
